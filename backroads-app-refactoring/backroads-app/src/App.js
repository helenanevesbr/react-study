...
function App() {
  ...
  return <> {/*To return only one parent component, we can either set up some tags or we can simply go here with a react fragment*/}
    <nav className="navbar">
      <div className="nav-center">
        ...
        {/*<!-- left this comment on purpose --> // if you have some comments coming from HTML, JSX will complain.*/}
